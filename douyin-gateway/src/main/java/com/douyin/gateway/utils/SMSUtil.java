...
import com.douyin.gateway.properties.TencentCloudProperties;
...
public class SMSUtil {
    ...
    public void sendSMS(String phone, String code) throws Exception {
        try {
            ...
            req.setSmsSdkAppId("1400674990"); // 短信应用ID: 短信SdkAppId在 [短信控制台] 添加应用后生成的实际SdkAppId
            req.setSignName("逐梦IT者聚集地"); // 签名
            req.setTemplateId("1395657"); // 模板id：必须填写已审核通过的模板 ID。模板ID可登录 [短信控制台] 查看
